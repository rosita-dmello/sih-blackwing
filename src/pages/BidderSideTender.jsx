...
function createData(reference_id, type, category, status) {
  return { reference_id, type, category, status };
}
    ...
    <Layout>
      ...
      >
        <Grid item style={{ textAlign: "center" }}>
          ...
          <Select options={types} onChange={(e)=>{setType(e.value)}} className='select-adj'/>
          <div>Filter by Category:</div>
          <Select options={categories} onChange={(e)=>{setCategory(e.value)}} className='select-adj'/>
